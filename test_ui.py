...
async def main():
    ...
    async with async_playwright() as p:
        ...
        # Take a screenshot of the realtime tab to check endpoint dropdown
        await page.screenshot(path="screenshot_realtime.png")

        # Go to history tab
        await page.click("#history-tab")
        await page.wait_for_timeout(1000)

        # We need mock history data
        await page.evaluate("""
            historyData = [
                {
                    "id": 1,
        ...
        await page.screenshot(path="screenshot_history_modal.png")
