...
| `src/components/final-cohort/ClickableCell.jsx` | UI Helper | Table cell helper supporting copy-to-clipboard and LLM logic trace popovers. |
| `src/components/final-cohort/VisualizerModal.jsx` | Modal Component | ECharts 4-step visualization wizard modal rendering 17 scientific chart types, data limiting, multi-level Sankey flows, styling controls, vector SVG and high-DPI PNG exports with dual string/object data handling matching SLR-IDE. |
...
| `src/components/research-workflow/ResearchWorkflowPanel.jsx` | View Component | Dynamic 5-group interactive SVG flowchart populated with live metrics from activeSession, featuring click-to-inspect drawers for Research Manifesto, RQs, QA Definitions, EC Rules, and Accounting spend. |
