...
export function VisualizerProvider({ children, props }: VisualizerProviderProps) {
  ...
  const generateSlotOption = useCallback((slotId: SlotId) => {
    ...
    return buildChartOption({
      ...
      decimalPrecision: slotConfig.decimalPrecision !== undefined ? slotConfig.decimalPrecision : style.decimalPrecision,
      useTildeForCoarse: slotConfig.useTildeForCoarse !== undefined ? slotConfig.useTildeForCoarse : style.useTildeForCoarse,
      ratioStyle: slotConfig.ratioStyle || style.ratioStyle,
      forceCohortDenominator: slotConfig.forceCohortDenominator !== undefined ? slotConfig.forceCohortDenominator : style.forceCohortDenominator,
