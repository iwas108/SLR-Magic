  ...
  return {
    ...
    scientific_rigor: {
      ...
      prisma: {
        ...
        systematic_search_strategies: prisma.systematic_search_strategies || scientificRigor.systematic_search_strategies || null,
      },
      ...
      systematic_search_strategies: scientificRigor.systematic_search_strategies || prisma.systematic_search_strategies || null,
      prisma_flow_data: scientificRigor.prisma_flow_data || prisma,
      pre_calibration_data: scientificRigor.pre_calibration_data || scientificRigor.pool_metrics || null,
      gold_standard_stage_comparison: scientificRigor.gold_standard_stage_comparison || scientificRigor.stage_comparisons || [],
