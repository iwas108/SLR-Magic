export type SyncType = 'SYNC_PAPERS' | 'SYNC_PROJECTS' | 'SYNC_PROMPTS' | 'SYNC_PIPELINE' | 'SYNC_ADJUDICATION' | 'SYNC_DUPLICATES' | 'SYNC_LLM_JOB' | 'SYNC_VAULT_KEYS' | 'SYNC_REFERENCES_BIB' | 'SYNC_CHARTS';
