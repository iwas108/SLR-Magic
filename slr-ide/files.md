...
| `src/lib/services/ecosystem-data.ts` | Backend / Domain Service | Master metadata dictionary for all SLR Magic ecosystem modules, technical stacks, capabilities, review lifecycle steps, file specifications (.slr, .slr-viewer, .csv, .bib), and dynamic URL port resolver. |
