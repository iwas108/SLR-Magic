...
import { X, ChevronDown, ChevronUp, BarChart3, Download, HelpCircle } from 'lucide-react';
    ...
    fetch(`/api/projects/${projectId}`)
      ...
      .then((data) => {
        if (data.success && data.project) {
          setProjectQuestions(data.project.questions || '');
        }
      })
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-card border border-border w-full max-w-2xl rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-border bg-secondary/10 flex justify-between items-center select-none">
          <button
