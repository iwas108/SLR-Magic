...
export default function ProjectSettingsModal({
  ...
  const mappedForm = {
    ...
    projectFormSearchQueries: form.searchQueries,
    handleAddSearchQuery: form.handleAddSearchQuery,
    handleUpdateSearchQuery: form.handleUpdateSearchQuery,
    handleRemoveSearchQuery: form.handleRemoveSearchQuery,
