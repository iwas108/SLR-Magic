...
export default function PipelineExecutionView(props: any) {
  ...
  return (
    <div className="h-full flex flex-col xl:flex-row gap-6 animate-in fade-in duration-300 relative">
      {/* LEFT COLUMN: Configuration */}
      <div className="w-full xl:w-80 shrink-0 flex flex-col gap-6 overflow-y-auto pr-2 custom-scrollbar">
        <LLMConfigView activeProject={activeProject} loadProjects={loadProjects} showToast={showToast} />
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-4">
          ...
          <p className="text-[11px] text-muted-foreground leading-relaxed">
            1. <strong className="text-foreground">Data Acquisition:</strong> Run the background scrapers to acquire PDFs.<br/>
            2. <strong className="text-foreground">LLM Operations:</strong> Start the semantic screening to extract JSON outcomes.
          </p>
        </div>
      </div>

      {/* RIGHT COLUMN: Execution Monitors */}
      <div className="flex-1 flex flex-col gap-6 min-w-0 h-full">
        
        {/* Top half: Data Acquisition */}
        <div className="h-1/2 flex flex-col bg-card border border-border/60 rounded-xl shadow-sm overflow-hidden">
