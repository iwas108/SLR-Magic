...
│   ├── static/                # Static assets generated by build step
│   └── templates/
...
1.  **Node.js & npm**: Required to build the Tailwind CSS stylesheet.
2.  **Python 3.8+**
3.  **Chrome Browser**: Ensure you have Google Chrome installed. The scraper uses the latest Chrome engine.
4.  **Ghostscript**: Required for PDF compression.
...
5.  **rclone**: Required for syncing to Google Drive.
