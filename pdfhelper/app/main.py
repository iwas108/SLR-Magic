...
def execute_task(task_name, func):
...
async def start_download(background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(execute_task, "downloader", run_downloader)
...
async def start_verify(background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(execute_task, "verifier", run_verifier)
...
async def start_compress(background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(execute_task, "compressor", run_compressor)
...
async def start_sync(background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(execute_task, "syncer", run_syncer)
