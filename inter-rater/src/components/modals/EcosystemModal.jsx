            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {ECOSYSTEM_MODULES.map((mod) => {
                  ...
                  const modUrl = resolveModuleUrl(mod.defaultPort, mod.id);
                  const isCopied = copiedPort === mod.defaultPort;
                    ...
                    >
                      ...
                      <div className="pt-3 border-t border-border/60 flex items-center justify-between gap-3 text-xs mt-2">
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          {mod.defaultPort && (
                            <button
                              onClick={() => handleCopyUrl(modUrl, mod.defaultPort)}
